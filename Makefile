...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp context.cpp natives.cpp handles.cpp

##############################################
### CONFIGURE ANY OTHER FLAGS/OPTIONS HERE ###
##############################################

C_OPT_FLAGS = -pipe -fno-strict-aliasing -O2 -ggdb3 -std=c++11
...
INCLUDE += -I. -I.. -Isdk -I$(SMSDK)/public -I$(SMSDK)/sourcepawn/include -Ilibs/libuv-1.33.1/include
...
LINK += -m32 -static-libstdc++
LINK += -Llibs/libuv-1.33.1
LINK += -Wl,-Bstatic -luv `curl-config --static-libs`
LINK += -Wl,-Bdynamic -lm -ldl -lrt -lpthread
#LINK += -L${JEMALLOC_PATH}/lib -Wl,-rpath,${JEMALLOC_PATH}/lib -ljemalloc
